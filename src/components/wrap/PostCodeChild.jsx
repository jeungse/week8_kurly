...
export default function PostCodeChild() {
    ...
    const onClickAddSave=(e) => {
        e.preventDefault();
        // 주소를 새로고침 해도 정보가 유지되도록
        // 세션스토레이지에 저장
        const addr = {
            주소1: post.주소1,
            주소2: post.주소2
        }
        sessionStorage.setItem(post.addKey, JSON.stringify(addr));
        setPost({
            ...post,
            isPostCode: false
        })
    ...
    return (
        <div id='postCodeBox'>
            <div id="form">
                <form action="" id="form">
                    <ul>
                        <li><h1><strong>샛벽배송</strong> <span>지역입니다.</span></h1></li>
                        ...
                        <li>
                            <input onChange={onChangeAdd2} type="text" id='add2' name='add2' value={post.주소2} />
                        </li>
                        <li>
                            <p>
                        ...
                        <li>
                            <button onClick={onClickAddSave}>저장</button>
                        </li>
                        <li>
